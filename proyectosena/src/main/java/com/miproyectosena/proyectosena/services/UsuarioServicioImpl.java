...
public class UsuarioServicioImpl implements IUsuarioServicio{
    ...
    public Usuario guardar(UsuarioDTO registroDTO) {
        Usuario usuario = new Usuario(registroDTO.getNombre(), registroDTO.getApellido(), registroDTO.getCorreo(), registroDTO.getNumeroCelular(), passwordEncoder.encode(registroDTO.getPassword()));
